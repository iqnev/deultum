...
private:	// functions
	bool	compatible( typentry type1, typentry type2 );
	...
	void	statpart( setofsymbols followers );
		void	compoundstatement( setofsymbols followers );
			void	statement( setofsymbols followers );
				void	variable( setofsymbols followers/**/, typentry &vartype/**/ );
					void	expression( setofsymbols followers/**/, typentry &exptype/**/ );
						void	simpleexpression( setofsymbols followers/**/, typentry &exptype/**/ );
							void	term( setofsymbols followers/**/, typentry &exptype/**/ );
								void	factor( setofsymbols followers/**/, typentry &exptype/**/ );
